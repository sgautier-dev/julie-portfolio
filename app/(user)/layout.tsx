...
export const metadata = {
	...
	description:
		"Julie Gautier Water Tales, Freediving Underwater Film Director, Creator of Aquaflow",
...
export default function RootLayout({
	...
	return (
      ...
      */}
			<head />
			<body
				className={`min-h-screen bg-slate-50 dark:bg-slate-900 dark:text-white ${quicksand.variable} ${leagueSpartan.variable} ${gistesy.variable}`}
			>
				<Header />
				{children}
				<Footer />
